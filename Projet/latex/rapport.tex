...
Nous avons utilisé la TF-IDF de la librairie Scikit-learn pour faire du prétraitement des données, nous avons vraiment exploré beaucoup de configurations et nous nous sommes arrêtés sur celle qui donnait les meilleurs résultats : \\
